<?php 
    ...
    class InfoLagenhet {
        ...
        function set_information(){
            ...
            $sql ="select h.fnamn , h.enamn, l.hyra , k.datum, k.kontrakt_namn, k.kontrakt, h.andrahand , p.avgift, l.lagenhet_id , h.hyresgast_id  from tidlog_hyresgaster h inner join tidlog_lagenhet l on h.lagenhet_id = l.lagenhet_id 
