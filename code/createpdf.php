...
$pdf->Line(135,219,135,210); //vertikal linje Första vertikala i mellan översta linjerna
$pdf->Line(165,219,165,210); //vertikal linje
...
$pdf->Line(0,218,250,220); // en rak linje. Andra övre linjen
...
$pdf->Text(108, 278, $attBetala); //BELOPP
