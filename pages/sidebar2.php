    ...
    <aside class="sidebar">
        ...
        <ul class="nano-content">
            ...
            <li class="sub-menu">
                ...
                <ul>
                    <li>
                        <a href="tables-basic.html">Tryckaren 7</a>
                    </li>

                    <li>
                        <a href="tables-data.html">Uttern 9</a>
                    </li>
                </ul>
            </li>
            <li class="sub-menu">
                ...
                <ul>
                    <li>
                        <a href="forms-components.html">Tryckaren 7</a>
                    </li>
                    <li>
                        <a href="forms-validation.html">Uttern 9</a>
                    </li>
                </ul>
            </li>
            <li class="sub-menu active">
                ...
                <ul>
                <li class="active"><a href="mail-inbox.html">Tryckaren 7</a>
                </li>
                <li><a href="mail-compose.html">Uttern 9</a>
                </li>
                </ul>
            </li>
            <li class="sub-menu">
                ...
                <ul>
                <li><a href="charts-chartjs.html">Avisering av hyror</a>
                </li>
                <li><a href="charts-morris.html">Kontroll av hyror</a>
                </li>
                <li><a href="charts-c3.html">Skapa faktura</a></li>
                </ul>
            </li>
